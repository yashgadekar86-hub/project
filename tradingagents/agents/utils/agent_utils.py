...
def build_instrument_context(
    ...
    instrument_label = "asset" if (is_crypto or is_commodity) else "instrument"
    context = (
        f"The {instrument_label} to analyze is `{ticker}`. "
        "Use this exact ticker in every tool call, report, and recommendation, "
        "preserving any exchange suffix (e.g. `.TO`, `.L`, `.HK`, `.T`, `-USD`, `=F`)."
    )
    ...
    if is_crypto:
        ...
        context += (
            " Treat it as a commodity (precious metal / energy future or spot) "
            "rather than a company. There are no earnings, balance sheets, or "
            "company financials. Its fundamentals are macro and supply/demand: "
            "real interest rates and the US dollar for metals, inventories and "
            "production for energy, plus central-bank and ETF flows for gold. "
