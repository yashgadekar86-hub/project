...
# Gold fork: gold futures (GC=F) and spot aliases route to the commodity
# pipeline instead of the equity one, so the agents never hunt for company
# financials on a metal. See tests/test_gold_mt5.py for the full matrix.
@pytest.mark.parametrize("raw,expected", [
